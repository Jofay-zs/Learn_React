      ...
      <form action="" className=" max-w-xl w-full px-5">
        <div className="grid grid-cols-2 gap-2">
          <div>
            ...
            <input
              className="py-2 my-1 relative w-full block px-3 border border-gray-300 text-gray-900 rounded-md focus:outline-none focus:border-indigo-500 focus:z-10 sm:text-sm"
              type="text"
              placeholder="Jofay"
              name="name"
              required="true"
        ...
        <div>
          <Link to="/admin">
            <button
              className="text-xl bg-indigo-500 px-4 py-2 text-white rounded-md hover:bg-indigo-600 my-5 w-full"
              type="submit"
            >
              Signup
            </button>
